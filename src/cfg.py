...
class CFG:
	...
	def generate_words(self, max_length: int, dynamic_round: bool=False) -> list:
		"""
		...
		dynamic_round (bool): Whether to use dynamic rounding for the probabilities (with default theshold) or not. Default is False.
