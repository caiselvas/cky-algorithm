...
def transform_probabilistic_to_deterministic(parse_trees_with_probs):
    """
    ...
    -------
    total_prob : float
        The total probability of the parse trees.
    parse_trees_deterministic : list
    """
...
def visualize_parse_trees(parse_trees_with_probs: list, prob: bool = True):
    ...
    """
    def add_nodes_edges(tree, graph: nx.DiGraph, parent: str = None, order: list = [0], layer: int = 0, idx: int = 0):
        """
        ...
        idx : int
            The index of the current tree to ensure unique node identifiers.
        """
